...
def init_dirs():
    ...
    directories = [
        ...
        os.path.join(settings.CONFIG_DIR, "shortcuts"),
        os.path.join(settings.CONFIG_DIR, "shortcuts", "other-versions"),
        os.path.join(settings.CONFIG_DIR, "shortcuts", "related-apps"),
        settings.DATA_DIR,
